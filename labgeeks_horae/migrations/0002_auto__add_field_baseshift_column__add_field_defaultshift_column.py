...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('labgeeks_horae_baseshift', 'column', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'DefaultShift.column'
        db.add_column('labgeeks_horae_defaultshift', 'column', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseShift.column'
        db.delete_column('labgeeks_horae_baseshift', 'column')

        # Deleting field 'DefaultShift.column'
        db.delete_column('labgeeks_horae_defaultshift', 'column')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 14, 50, 39, 859398)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 14, 50, 39, 859260)'}),
        ...
        'labgeeks_horae.timeperiod': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 29)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 29)'})
        },
